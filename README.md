...
# IT Step JavaScript Assignments

##  Based on [Brest IT Shark](https://it-shark.pro/) Javascript Assignments
...
* Run `git clone https://github.com/<your-account>/ItStep-js-tasks.git` from command line to download the repo.
